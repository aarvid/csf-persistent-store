...
(declaim (ftype (function (symbol-table)        array-index)
         ...
         (ftype (function (symbol-table string) array-index)
                symbol-table/intern-string)
         (ftype (function (symbol-table array-index) string)
                symbol-table/resolve-string)
         (ftype (function (symbol-table)        array-index)
                symbol-table/symbol-count)
         (ftype (function (symbol-table symbol) array-index)
                symbol-table/intern-symbol)
         (ftype (function (symbol-table array-index) symbol)
                symbol-table/resolve-symbol)
         (ftype (function (symbol-table)        array-index)
                symbol-table/did-count)
         (ftype (function (symbol-table distributed-identifier) array-index)
                symbol-table/intern-did)  ;; $$$ 2nd argument type was wrong.
         (ftype (function (symbol-table array-index) symbol)
                symbol-table/resolve-did)
